...
2. FIRST START & SETUP
   ...
   - MOD SUPPORT: If you use Steam Workshop Mods, click the "WORKSHOP" button in the
     main menu to select your workshop folder (usually detected automatically).
...
3. HOW TO PLAY
   ...
   - SHIPYARD: Buy ships for your fleet.
     -> Modded ships are marked with (MOD).
   - PORT: Repair your ships or sell them.
     -> Tip: Repairing a ship is 40% cheaper than buying a new one!
     -> Warning: Ships have wear & tear. Damaged ships (<25%) have a chance
        to break down/sink during deployment!
   - OPS CENTER:
     1. Select a mission from the list (Vanilla & Mod missions supported).
   ...
   - DEBRIEFING (Important!):
     ...
     - Use the counters [-] / [+] to register destroyed enemies.
     - RULES OF ENGAGEMENT: Destroying civilian targets (red text) results
       in massive financial penalties (War Crimes)!
...
* Realism Mode: Ships degrade over time. Bad maintenance leads to engine failures.
* Workshop Support: Automatically detects Mod-Ships and Mod-Missions.
* War Crimes Logic: You get paid for enemies, but fined for civilian casualties.
...
2. ERSTER START
   ...
   - MODS: Falls du Mods nutzt, klicke im Hauptmenü auf "WORKSHOP", damit
     das Tool deine Mods und Workshop-Missionen laden kann.
...
3. SPIELABLAUF
   ...
   - WERFT: Kaufe Schiffe für deine Flotte. Mod-Schiffe sind markiert.
   - HAFEN: Repariere oder verkaufe Schiffe.
     -> Tipp: Reparieren ist 40% günstiger als ein Neukauf!
     -> Achtung: Schiffe nutzen sich ab. Wer mit <25% Zustand startet, riskiert
        Totalausfälle auf dem Weg zum Zielgebiet!
   - EINSATZ (Ops Center):
     1. Wähle eine Mission aus der Liste links (Vanilla & Mods).
   ...
   - IM SPIEL:
     - Starte Sea Power.
     - Gehe zu "SZENARIOS" -> "User Mission".
   ...
   - DEBRIEFING (Wichtig!):
     ...
     - Nutze die Tasten [-] und [+], um deine Abschüsse einzutragen.
     - KRIEGSVERBRECHEN: Rote Ziele sind Zivilisten! Wer diese versenkt,
       zahlt massive Geldstrafen (je nach Schwierigkeitsgrad).
...
* Workshop Support: Volle Unterstützung für Mod-Schiffe und Mod-Kampagnen.
* Rules of Engagement: Belohnung für Feinde, harte Strafen für zivile Opfer.
